 ...
 *
 */
public class WcsOrderMessageListener implements MessageListener {
	
	private static final Logger logger = LoggerFactory.getLogger(WcsOrderMessageListener.class);
	...
	@Value("${redis.wcs.key.order.err}")
	private String redis_W_key_order_err;
